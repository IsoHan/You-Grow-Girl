		...
		<div className='font-link'>
			<Container>
				<Row>
					...
					>
						<div>
							<h2 className='page-title' style={{ color: '#437e85' }}>
								<b>Plants made easy</b>
							</h2>
							<br />
							<p style={{ fontSize: '20px' }}>
								You Grow Girl helps you get the best for your floral friends
							</p>
							<hr />
							<p style={{ fontSize: '20px' }}>
								<ul>
									<li>
										Here at You Grow Girl we help you care for your plants in
										the best possible way
									</li>
									<li>
										Find information about the plants that will suit you best,
										and how to grow them to be healthy, tall, and strong
									</li>
									<li>
										Discover Your Garden to save your plants and keep all of
										your information in one convenient place
									</li>
								</ul>
							</p>
							<NavLink to='/signin'>
