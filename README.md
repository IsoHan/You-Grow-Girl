...
2. in 'backend' folder, you will be required to download all python dependencies such as those needed for the Django rest_framework and simple JWT token authentication. To do so please enter the following command:
